...
<script type="text/template" id="tmpl-elementor-new-template">
	<div id="elementor-new-template__description">
		<div id="elementor-new-template__description__title"><?php echo esc_html__( 'Templates Help You', 'woocommerce-builder-elementor')?> <span><?php echo esc_html__( 'Work Efficiently', 'woocommerce-builder-elementor')?></span></div>
