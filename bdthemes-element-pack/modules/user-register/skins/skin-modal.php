...
class Skin_Modal extends Elementor_Skin_Base {
	...
	public function render() {
		...
		<div class="bdt-user-register bdt-user-register-skin-modal">
			...
			<div id="<?php echo esc_attr($modal_id); ?>" class="bdt-flex-top bdt-user-register-modal" bdt-modal>
	...
	protected function render_text() {
		...
		$modal_button_icon_attr['class']    = ['bdt-modal-button-icon', 'elementor-button-icon', 'bdt-button-icon-align-' . $this->get_instance_value('modal_button_icon_align')];
