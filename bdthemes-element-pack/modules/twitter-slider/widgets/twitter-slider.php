...
class Twitter_Slider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Twitter Slider', 'bdthemes-element-pack' );
	}
	...
	private function register_query_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-twitter-slider .bdt-carousel-item .bdt-twitter-text, {{WRAPPER}} .bdt-twitter-slider .bdt-carousel-item .bdt-twitter-text *' => 'color: {{VALUE}};',
				],
			]
		);
