...
Class Hero_10_View extends HeroViewAbstract
{
    public function render_block_type_1($post)
    {
        if($post) {
            ...
            $output =
                "<article " . epic_post_class("jeg_post jeg_hero_item_1", $post->ID) . " style=\"padding: 0 0 {$this->margin}px {$this->margin}px;\">
    ...
    public function render_block_type_2($post, $index)
    {
        ...
        if($post) {
            ...
            $output =
                "<div " . epic_post_class("jeg_post jeg_hero_item_{$index}", $post->ID) . " style=\"padding: 0 0 {$this->margin}px {$this->margin}px;\">
                <div class=\"jeg_block_container\">
                    " . epic_edit_post( $post->ID ) . "
                    <span class=\"jeg_postformat_icon\"></span>
                    <div class=\"jeg_thumb\">
