...
Class Block_14_View extends BlockViewAbstract
{
    ...
    public function build_column_1($results)
    {
        ...
        for($i = 1; $i < sizeof($results); $i++) {
            $second_block .= $this->render_block_type_2($results[$i], 'epic-360x180');
        }

        $output =
            "<div class=\"jeg_posts_wrap\">
                <div class=\"jeg_postbig\">
                    <article " . epic_post_class("jeg_post jeg_pl_lg_box", $results[0]->ID) . ">
                        <div class=\"box_wrap\">
                            {$first_block}
                        </div>
                    </article>
    ...
    public function build_column_1_alt($results)
    {
        ...
        for($i = 0; $i < sizeof($results); $i++) {
            $first_block .= $this->render_block_type_2($results[$i], 'epic-360x180');
        }
    ...
    {
        $first_block = $this->render_block_type_1($results[0], 'epic-750x375');
    ...
    {
        $first_block = $this->render_block_type_1($results[0], 'epic-1140x570');
