function jegSetSettingValue(control, value) {
    "use strict";
    ...
    if ('jeg-toggle' === controlType) {
    ...
    } else if ('jeg-select' === controlType || 'jeg-preset' === controlType) {
    ...
    } else if ('jeg-slider' === controlType) {
    ...
    } else if ('jeg-generic' === controlType && undefined !== subControl.choices && undefined !== subControl.choices.element && 'textarea' === subControl.choices.element) {
    ...
    } else if ('jeg-color' === controlType) {

        alphaColorControl = container.find('.jeg-color-control');

        alphaColorControl.val(value).trigger('change');

        setting.set(value);

    } else if ('jeg-multicheck' === controlType) {
    ...
    } else if ('jeg-radio-buttonset' === controlType || 'jeg-radio-image' === controlType || 'jeg-radio' === controlType || 'jeg-dashicons' === controlType || 'jeg-color-palette' === controlType || 'jeg-palette' === controlType) {
    ...
    } else if ('jeg-typography' === controlType) {
        ...
        if (undefined !== value.color) {
            ...
            // Update the value visually in the control
            typographyColor = container.find('.jeg-color-control');
