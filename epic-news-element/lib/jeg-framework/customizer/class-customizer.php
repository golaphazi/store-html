...
class Customizer {
	...
	public function customizer_styles() {
		...
		wp_enqueue_style( 'font-awesome', JEG_URL . '/fonts/font-awesome/font-awesome.min.css', null, $this->version );

		wp_enqueue_style( 'jeg-ion-range-slider', JEG_URL . '/assets/css/ion.rangeSlider.css', null, $this->version );
		wp_enqueue_style( 'jeg-ion-range-slider-skin', JEG_URL . '/assets/css/ion.rangeSlider.skinFlat.css', null, $this->version );
	...
	public function enqueue_control_script() {
		...
		wp_localize_script( 'jeg-lazy-section', 'lazySetting', array(
			'ajaxUrl' => add_query_arg( array( $this->endpoint => 'jeg' ), home_url( '/' ) ),
	...
	public function previewer_script() {
		...
		wp_localize_script( 'jeg-customizer-output-preview', 'outputSetting', array(
