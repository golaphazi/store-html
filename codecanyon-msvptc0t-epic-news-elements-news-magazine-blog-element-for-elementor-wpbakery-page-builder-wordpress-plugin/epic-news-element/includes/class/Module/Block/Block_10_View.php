...
Class Block_10_View extends BlockViewAbstract
{
    public function render_block_type_1($post, $image_size)
    {
        ...
        $output =
            "<article " . epic_post_class("jeg_post jeg_pl_lg_4", $post->ID) . ">
    ...
    public function build_column_2($results)
    {
        ...
        for ( $i = 0; $i < sizeof($results); $i++ )
        {
            ...
            $first_block .= $this->render_block_type_1($results[$i], 'epic-750x375');
        }
    ...
    public function build_column_3($results)
    {
        ...
        for ( $i = 0; $i < sizeof($results); $i++ )
        {
            ...
            $first_block .= $this->render_block_type_1($results[$i], 'epic-1140x570');
        }
