...
class Notice {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_metwoo-notices', [ $this, 'dismiss' ] );
	}
	...
	public function enqueue_scripts() {
		echo "
			...
			jQuery(document).ready(function ($) {
				$( '.metwoo-notice.is-dismissible' ).on( 'click', '.notice-dismiss', function() {
					_this 		= $( this ).parents( '.metwoo-active-notice' );
	...
	public static function push($notice) {
		...
		// Notice ID.
		$notice_id    = 'metwoo-sites-notice-id-' . $notice['id'];
		$notice['id'] = $notice_id;
		if ( ! isset( $notice['id'] ) ) {
			$notice_id    = 'metwoo-sites-notice-id-' . $notice['id'];
			$notice['id'] = $notice_id;
